# Data Mining Project, Spring 2026
## Short-Term Stock Portfolio Optimization for Retail Investors
### Team: BiznesDengi

### Roles in team:
- Project Manager: Aleliya Turushkina (from DS-02)
- Business Unit: Ivan Ilyichev (from DS-01)
- Data Scientist: Maksim Ilin (from DS-01)
- Model Developer: Lev Permiakov (from DS-02)
- Business Analyst: Arina Petuhova (from DS-02)
